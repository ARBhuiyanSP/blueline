                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages" style="border:1px solid gray;border-radius:5px;background-color:#f5faf3;">
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" name="contact_form" id="contact_form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                        ...
                                        <div class="form-group ">
											...
											<div class="form-group account-btn text-center m-t-30">
												<div class="col-xs-12">
													<button class="btn btn-block btn-bordered btn-danger waves-effect waves-light" name="submit" type="submit">Log In</button>
												</div>
											</div>
                                        </div>
