                            ...
                            <tbody>
                                <tr id="" bgcolor="#f2f2f2" class="edit_tr">
                                    ...
                                    echo $rowc['assets_category']
                                        ...
                                        <td><span class="text"><img src="<?php echo $row['qr_image'] ?>" height="50" /></span></td>
                                        <td><span class="text"><img src="products_photo/<?php echo $row['pro_photo'] ?>" height="50" /></span></td>
                                        <td class='text-center'> 
                                            <a href="products_edit.php?id=<?php echo $row['id'] ?>"><button><i class="fa fa-edit text-success"></i></button></a>

                                            <button onclick="" class=''><i class="fa fa-trash text-danger"></i></button>
