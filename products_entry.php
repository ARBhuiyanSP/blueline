								...
								<form action="add_product.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-xs-3">
										<div class="form-group">
											...
											<select id="at" name="assets_type" class="form-control select2" required >
									...
									<div class="col-xs-2">
										<div class="form-group">
											<label>Custody</label>
											<input name="custody" type="text" class="form-control" id="mobileno" value="" size="30" required />
										</div>
									</div>
									<div class="col-xs-2">
										<div class="form-group">
									...
									<div class="col-xs-12">
										<p>
											<input type="submit" name="Submit" id="Submit" class="btn btn-info btn-block" value="Save Data" required  />
										  </p>
									</div>
								</form>	
								</div>
